...
tmux split-window "sleep 10 && cd $root_dir/event_orin_drone && jetson-containers run -v .:/workspace -w /workspace/ros --user $(id -u):$(id -g) --ipc=host event_orin_drone ros2 launch eo_drone sim_external_modes.launch.py; exec $SHELL"
