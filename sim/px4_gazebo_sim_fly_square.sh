...
tmux split-window "sleep 10 && cd $root_dir/event_orin_drone && jetson-containers run -v .:/workspace --user $(id -u):$(id -g) --ipc=host event_orin_drone ros2 run eo_drone fly_square"
